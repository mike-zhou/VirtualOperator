...
{
    STEPPER_OK = 0,
    STEPPER_ERROR_INVALID_ID,
    STEPPER_ERROR_INVALID_GPIO_PORT,
    STEPPER_ERROR_INVALID_GPIO_PIN_INDEX,
    STEPPER_ERROR_INVALID_READY_STEPS,
    STEPPER_ERROR_INVALID_RANGE,
    STEPPER_ERROR_INVALID_ENCODER_ID,
    STEPPER_ERROR_INVALID_CONTROL_PARAMETER,
    STEPPER_ERROR_INVALID_PASSIVE_ID,
    STEPPER_ERROR_NO_PULSE,
    STEPPER_ERROR_INVALID_PULSE_LENGTH,
    STEPPER_ERROR_NO_INDEX,
    STEPPER_ERROR_INVALID_INDEX_LENGTH,
    STEPPER_ERROR_WRONG_BATCH_INDEX,
    STEPPER_ERROR_WRONG_PULSE_WIDTH,
    STEPPER_ERROR_WRONG_PULSE_ORDER,
    STEPPER_ERROR_INTERNAL_DATA_ERROR,
    STEPPER_ERROR_TOO_MANY_PULSE_WIDTHS,
    STEPPER_ERROR_TOO_MANY_PASSIVE_INDEXES,
    STEPPER_ERROR_WRONG_INIT_ORDER,
    STEPPER_ERROR_WRONG_STATE,
    STEPPER_ERROR_INVALID_ACTIVE_PULSES,
    STEPPER_ERROR_INVALID_PASSIVE_INDEXES,
    STEPPER_ERROR_WILL_OUT_OF_RANGE,
    SETPPER_ERROR_ALREADY_COUPLED,
    STEPPER_ERROR_NOT_COUPLED,
    STEPPER_ERROR_NULL_PARAMETER,
    STEPPER_ERROR_NOT_SUPPORT_SYNC,
...
typedef enum 
{
    STEPPER_STATE_UNINITIALIZED = 0,  // data about stepper hasn't been initialized
    STEPPER_STATE_INITIALIZED,        // all data about stepper has been initialized
    STEPPER_STATE_RETURN_TO_HOME_BOUNDARY,
    STEPPER_STATE_HOME_BOUNDARY_TO_READY,
    STEPPER_STATE_READY,              // the stepper is ready to be clocked
    STEPPER_STATE_RUNNING_ACTIVE,
    STEPPER_STATE_RUNNING_PASSIVE,
    STEPPER_STATE_RUNNING_FORCED,
    STEPPER_STATE_OUT_OF_SYNC,        
    STEPPER_STATE_OUT_OF_BOUNDARY,    // boundary detector is triggered
    STEPPER_STATE_DRIVER_ALARM,       // the stepper driver activates alarm signal
    STEPPER_STATE_COUNT
} StepperState;
